...
namespace AssaultCubeTrainer.App.Utils
{
    ...
    public class GlobalKeyboardHook : IDisposable
    {
        ...
        public IntPtr LowLevelKeyboardProc(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            if (Enum.IsDefined(typeof(KeyboardState), wparamTyped))
            {
                ...
                if (o is LowLevelKeyboardInputEvent p)
                {
                    var eventArguments = new GlobalKeyboardHookEventArgs(p, (KeyboardState)wparamTyped);
                    KeyboardPressed?.Invoke(this, eventArguments);
                    eatKeyStroke = eventArguments.Handled;
                }
            }

            return eatKeyStroke ? (IntPtr)1 : CallNextHookEx(IntPtr.Zero, nCode, wParam, lParam);
        }
    }
}
